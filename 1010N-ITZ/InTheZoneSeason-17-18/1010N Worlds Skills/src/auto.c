...
void twotwentyleft(){
  ...
  moveArm(0);
  delay(100);
  armP(UP, 1600, 500); //was 1800 //was 2000
  moveArm(armCounter);
  moveChainBar(-127);
  delay(500);
  moveChainBar(-30);
  ...
  drive(-1, 1550);//1100 for 1 cone 1550 for 2 cones
  gyroReset(gyro);
  turn(LEFT,45,450,2.5,5.5);
  moveIntake(127);
  drive(-1, 800);
  turn(LEFT,90,650,2.5,5.5);
  armP(UP, 1900, 500); //was 1750
  moveDrive(90,90);
  delay(1100);
  moveDrive(50,50);
  moveMogo(90);
...
void threefiveleft() {
  ...
  delay(300);
  //Second cone
  drive(FORWARD,170);//was 160 -- 130 Works
  moveChainBar(127);
  moveIntake(-127);
  moveArm(0);
  armDown(2350);
